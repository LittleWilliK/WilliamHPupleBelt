...
public class PlayerControls : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        rb.velocity += transform.rotation * (Vector3.right * Input.GetAxisRaw("Horizontal") * 10 * Time.deltaTime);
        rb.velocity += transform.rotation * (Vector3.right * Input.GetAxisRaw("Vertical") * 10 * Time.deltaTime);
